...
public class CollectionUtil {
	...
	public void eliminaNombresConEspacios(List<Persona> original) {
		// original.stream().map(o -> o.getNombre().contains(" "));
		original.removeIf(o -> o.getNombre().contains(" "));
	}
	...
	public void pasarAMayusculas(List<Persona> original) {
		original.replaceAll(p -> new Persona(p.getNombre().toUpperCase(), p.getApellido1().toUpperCase(),
